...
public class GameApplication {
	public static void main(String[] args) {
		...
		for (int i = 0; i < 50; i++) {
			...
			System.out.println("Piece Position before and after following a " + dice_roll + ": " + piece.getPosition().toString() + " -> " + newProposedPosition.toString());
			...
			if (distanceFromWin == 0) {
				...
				System.out.println("Piece bounced off the end and knocked back by " + distanceFromWin);
				GridPosition backPos = piece.moveBackward(distanceFromWin);
